...
class AttendanceForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['course', 'time_duration', 'attended', 'comments']
...
class NumberOfClassesForm(forms.Form):
    number_of_classes = forms.ChoiceField(choices=[(i, str(i)) for i in range(1, 6)], label="How many classes did you attend today?")